...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'©Rama', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': '©Rama', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "RamaKull", "caption": '©Rama', 'jpegThumbnail': thumb}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/a69277968591202ee81e8.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://wa.me/628985476150\n\n*Atau Transfer via*\n- *Dana*\n Ke nomer berikut : 08985476150\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/628985476150')
            }
            break		 
            case 'chat': {
...
├ *Wit* : ${timur} WIT
╰──❍
_*JANGAN SPAM BOT YA..TUNGGU SAJA NANTI KELUAR*_✅`
